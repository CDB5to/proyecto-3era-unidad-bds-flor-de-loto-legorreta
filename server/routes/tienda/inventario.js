    ...
    try {
        ...
        if (tienda.length <= 0) {
            ...
            res.status(200).send({
                estatus: '200',
                err: false,
                msg: 'Informacion obtenida de manera correcta',
                cont: {
                    tienda
                }
            });
